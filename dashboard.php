                        ...
                        <div class="row">
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
								    <?php 
									 ...
									 $sql1= "SELECT(SELECT COUNT(*) FROM Walla WHERE Summary LIKE '%תקף%' or Summary LIKE '%תקפ%' or Summary LIKE '%היכה%')+(SELECT COUNT(*) FROM Ynet WHERE Summary LIKE '%תקף%' or Summary LIKE '%תקפ%' or Summary LIKE '%היכה%')+(SELECT COUNT(*) FROM Haaretz WHERE Title LIKE '%תקף%' or Title LIKE '%תקפ%' or Title LIKE '%היכה%')+(SELECT COUNT(*) FROM Kan WHERE Title LIKE '%תקף%' or Title LIKE '%תקפ%' or Title LIKE '%היכה%') as Num";
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-warning text-white mb-4">
									 ...
									 $sql1= "SELECT(SELECT COUNT(*) FROM Walla WHERE Summary LIKE '%אקדח%' or Summary LIKE '%נשק%' or Summary LIKE '%נורה%') + (SELECT COUNT(*) FROM Ynet WHERE Summary LIKE '%אקדח%' or Summary LIKE '%נשק%' or Summary LIKE '%נורה%') +(SELECT COUNT(*) FROM Haaretz WHERE Title LIKE '%אקדח%' or Title LIKE '%נשק%' or Title LIKE '%נורה%')+(SELECT COUNT(*) FROM Kan WHERE Title LIKE '%אקדח%' or Title LIKE '%נשק%' or Title LIKE '%נורה%') as Num";
